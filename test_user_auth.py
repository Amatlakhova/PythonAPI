...
class TestUserAuth:
    def test_user_auth(self):
        ...
        assert "x-csrf-token" in response1.headers, "There is no x-crsf-token token in the response"
    ...
    def test_negative_auth_check(self, condition):
        ...
        assert "user_id" in response1.json(), "There is no user_id in the second response"
